...
classes = (BPMOpenShot,
            ...
            BPM_PT_sequencer_shot_version_subpanel,
            BPM_PT_sequencer_shot_sync_subpanel,
            BPM_PT_sequencer_shot_comment_subpanel,
            BPM_PT_sequencer_shot_display_subpanel,
            BPM_PT_sequencer_shot_render_subpanel,
            BPM_PT_sequencer_shot_debug_subpanel,
            BPM_PT_sequencer_asset_library_panel,
            BPM_PT_sequencer_ui_panel,
            BPM_PT_sequencer_ui_shot_subpanel,
            BPM_PT_sequencer_ui_shot_state_subpanel,
            BPM_PT_sequencer_ui_frame_comment_subpanel,
            BPM_PT_sequencer_ui_preview_subpanel,
            BPM_PT_properties_shot_viewport_panel,
            BPM_PT_properties_shot_tracking_viewport_subpanel,
            BPM_PT_properties_shot_sync_viewport_subpanel,
            BPM_PT_properties_shot_comment_viewport_subpanel,
            BPM_PT_properties_shot_render_viewport_subpanel,
            BPM_PT_properties_shot_debug_viewport_subpanel,

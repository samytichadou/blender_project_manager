...
class BPM_PR_shot_settings(bpy.types.PropertyGroup) :
    ...
    shot_version_used : bpy.props.IntProperty(name = "Shot version", default = 1, min = 1)
    shot_version_file : bpy.props.IntProperty(name = "Shot version", default = 1, min = 1)
    shot_last_version : bpy.props.IntProperty(name = "Shot last version", default = 1, min = 1, update = updateShotSettingsProperties)
    not_last_version : bpy.props.BoolProperty(default=False)
...
class BPM_PR_scene_settings(bpy.types.PropertyGroup) :
    ...
    color_shot_comments : bpy.props.FloatVectorProperty(name="Shot comments color", subtype='COLOR', default=(1, 1, 0, 1), min=0.0, max=1.0, size=4)
    ...
    color_shot_comments_boxes : bpy.props.FloatVectorProperty(name="Shot comments boxes color", subtype='COLOR', default=(0, 0, 0, 0.95), min=0.0, max=1.0, size=4)
